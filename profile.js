...
const BACKUP_KEYS = ["ff_profile","ff_trainingDays","ff_attendance","ff_makeups","ff_routineTypeLog","ff_focus","ff_swaps","ff_weightLog","ff_lifts","ff_measures","ff_nutriLog","ff_nutriMenu","ff_splitAnchors"];
function exportData(){
